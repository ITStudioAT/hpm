    ...
    methods: {
        selectTakeIt(data) {
            ...
            switch (this.is_select) {
                ...
                case 'line_1_col_1_tablet':
                    this.header.structure.rows.row_1.tablet.columns.col_1.image = data.current_folder + '/' + data.file;;
                    break;
                case 'line_1_col_2_tablet':
                    this.header.structure.rows.row_1.tablet.columns.col_2.image = data.current_folder + '/' + data.file;;
                    break;
                case 'line_1_col_3_tablet':
                    this.header.structure.rows.row_1.tablet.columns.col_3.image = data.current_folder + '/' + data.file;;
                    break;

                case 'line_1_col_1_handy':
                    this.header.structure.rows.row_1.handy.columns.col_1.image = data.current_folder + '/' + data.file;;
                    break;
                case 'line_1_col_2_handy':
                    this.header.structure.rows.row_1.handy.columns.col_2.image = data.current_folder + '/' + data.file;;
                    break;
                case 'line_1_col_3_handy':
                    this.header.structure.rows.row_1.handy.columns.col_3.image = data.current_folder + '/' + data.file;;
                    break;
